...
export const agendaItems = [
  {
    title: dates[0],
    data: [
      { hour: "12am", duration: "1h", title: "Terapie pentru adolescenti" },
      {
        hour: "9am",
        duration: "1h",
  ...
  },
  {
    title: dates[1],
    data: [
      { hour: "4pm", duration: "1h", title: "Alcolici anonimi" },
      { hour: "5pm", duration: "1h", title: "Terapie pentru adolescenti" },
    ],
  },
  {
    title: dates[2],
